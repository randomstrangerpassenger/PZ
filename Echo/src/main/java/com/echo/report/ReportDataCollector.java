...
public class ReportDataCollector {
    ...
    private Map<String, Object> generateHeavyFunctions() {
        ...
        byMax.sort((a, b) -> Long.compare(b.getMaxMicros(), a.getMaxMicros()));
        ...
        byCount.sort((a, b) -> Long.compare(b.getCallCount(), a.getCallCount()));
    ...
    private List<RankedFunction> collectHeavyFunctions() {
        ...
        functions.sort((a, b) -> Long.compare(b.getTotalMicros(), a.getTotalMicros()));
        return functions;
    }
    ...
    private Map<String, Object> generateFuseDeepAnalysis() {
        // v4 Phase 3: ReportSpiAdapter로 위임
        Map<String, Object> result = ReportSpiAdapter.getInstance().generateFuseDeepAnalysis();

        // Echo 내부 프로파일러는 여기서 추가
