--[[
    ...
    Dev-only module. Keep this outside Iris/media/ so production packages do
    not auto-load or ship it. To run it in game, stage this _dev/media overlay
    into the mod and enable DEBUG + RUN_TESTS_ON_START.
...
local Generator = require("Iris/Logic/IrisDesc/Generator")
...
local function report(name, passed, message)
    if passed then
        ...
        Logger.error("[FAIL] " .. name .. ": " .. (message or ""))
    end
end
...
function IrisDescTest.runAll()
    ...
    Logger.info("========================================")
    Logger.info("[IrisDesc] Test Results: " .. passCount .. " passed, " .. failCount .. " failed")
    Logger.info("========================================")
