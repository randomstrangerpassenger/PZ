...
class PostCleanupPhase3Pkg2CombatReuseTest(unittest.TestCase):
    def test_build_pkg2_combat_reuse_promotes_only_safe_rows(self) -> None:
        ...
        try:
            ...
            base_facts_path = tmp / "dvf_3_3_facts.adopted DVF_AUTHORITY_ROLE_MIGRATION[667cc6017448a701af7ad75d3e315a51].jsonl"
            base_decisions_path = tmp / "dvf_3_3_decisions.adopted DVF_AUTHORITY_ROLE_MIGRATION[9eea38faa713d3c99aed6661f871706e].jsonl"
