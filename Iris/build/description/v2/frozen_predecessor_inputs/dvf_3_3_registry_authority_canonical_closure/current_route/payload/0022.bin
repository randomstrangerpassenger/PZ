...
class PostCleanupPhase3Pkg3CCampingAndFireSetupTest(unittest.TestCase):
    def test_build_pkg3c_promotes_only_tent_rows(self) -> None:
        ...
        try:
            ...
            base_facts_path = tmp / "dvf_3_3_facts.adopted DVF_AUTHORITY_ROLE_MIGRATION[59e16814924fd61f73d3c7c81cfaefb8].jsonl"
            base_decisions_path = tmp / "dvf_3_3_decisions.adopted DVF_AUTHORITY_ROLE_MIGRATION[85bfc2486399d58ef98ef6c1f89435e7].jsonl"
            output_dir = tmp / "out"
