...
class PostCleanupPhase3Pkg3DWaterAndContainerHandlingTest(unittest.TestCase):
    def test_build_pkg3d_promotes_only_empty_paint_bucket(self) -> None:
        ...
        try:
            ...
            base_facts_path = tmp / "dvf_3_3_facts.adopted DVF_AUTHORITY_ROLE_MIGRATION[b752e5e60a3d613a82c90f89df9358fb].jsonl"
            base_decisions_path = tmp / "dvf_3_3_decisions.adopted DVF_AUTHORITY_ROLE_MIGRATION[b66d73d33ba61fa5ac46fb93806fc252].jsonl"
            output_dir = tmp / "out"
