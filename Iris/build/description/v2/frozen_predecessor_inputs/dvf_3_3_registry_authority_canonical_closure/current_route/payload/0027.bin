...
class PostCleanupPhase3Pkg6ResidualTailTest(unittest.TestCase):
    def test_build_pkg6_promotes_bucket_water_and_bleach_only(self) -> None:
        ...
        try:
            ...
            base_facts_path = tmp / "dvf_3_3_facts.adopted DVF_AUTHORITY_ROLE_MIGRATION[e403d8b1a57cbb35c7f5f81a0568084b].jsonl"
            base_decisions_path = tmp / "dvf_3_3_decisions.adopted DVF_AUTHORITY_ROLE_MIGRATION[00ef7fe9a578dbbd4e716f868717bb43].jsonl"
            output_dir = tmp / "out"
