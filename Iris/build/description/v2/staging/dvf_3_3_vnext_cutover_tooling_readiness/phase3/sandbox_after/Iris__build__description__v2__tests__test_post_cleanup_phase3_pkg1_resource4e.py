...
class PostCleanupPhase3Pkg1Resource4ETest(unittest.TestCase):
    def test_build_pkg1_resource4e_promotes_only_safe_reuse_rows(self) -> None:
        ...
        try:
            ...
            base_facts_path = tmp / "dvf_3_3_facts.adopted DVF_AUTHORITY_ROLE_MIGRATION[59dca9e5d27835f7873b52fed0d917be].jsonl" DVF_AUTHORITY_ROLE_MIGRATION[59dca9e5d27835f7873b52fed0d917be]
            base_decisions_path = tmp / "dvf_3_3_decisions.adopted DVF_AUTHORITY_ROLE_MIGRATION[af200262c865de689e351bad5e82eef3].jsonl" DVF_AUTHORITY_ROLE_MIGRATION[af200262c865de689e351bad5e82eef3]
            output_dir = tmp / "out"
