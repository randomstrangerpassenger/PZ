...
class PostCleanupPhase3Pkg3BVehicleServiceUtilityTest(unittest.TestCase):
    def test_build_pkg3b_promotes_only_empty_fuel_container(self) -> None:
        ...
        try:
            ...
            base_facts_path = tmp / "dvf_3_3_facts.adopted DVF_AUTHORITY_ROLE_MIGRATION[769864ebf94b4c72c37b339d60f0da62].jsonl" DVF_AUTHORITY_ROLE_MIGRATION[769864ebf94b4c72c37b339d60f0da62]
            base_decisions_path = tmp / "dvf_3_3_decisions.adopted DVF_AUTHORITY_ROLE_MIGRATION[97aad4ae2fc6273fe633f1869645ad2a].jsonl" DVF_AUTHORITY_ROLE_MIGRATION[97aad4ae2fc6273fe633f1869645ad2a]
            output_dir = tmp / "out"
