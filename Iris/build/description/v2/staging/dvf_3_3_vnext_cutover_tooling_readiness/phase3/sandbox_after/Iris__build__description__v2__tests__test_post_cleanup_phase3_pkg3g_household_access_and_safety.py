...
class PostCleanupPhase3Pkg3GHouseholdAccessAndSafetyTest(unittest.TestCase):
    def test_build_pkg3g_promotes_only_padlock(self) -> None:
        ...
        try:
            ...
            base_facts_path = tmp / "dvf_3_3_facts.adopted DVF_AUTHORITY_ROLE_MIGRATION[1fa581bc7b2f1065f074943843155b10].jsonl" DVF_AUTHORITY_ROLE_MIGRATION[1fa581bc7b2f1065f074943843155b10]
            base_decisions_path = tmp / "dvf_3_3_decisions.adopted DVF_AUTHORITY_ROLE_MIGRATION[2d5d2856ac75a05f136efe54cfb2be91].jsonl" DVF_AUTHORITY_ROLE_MIGRATION[2d5d2856ac75a05f136efe54cfb2be91]
            output_dir = tmp / "out"
