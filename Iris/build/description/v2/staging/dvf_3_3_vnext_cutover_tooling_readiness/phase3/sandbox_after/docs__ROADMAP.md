...
* DVF 3-3 Live Migration Readiness Execution evidence root를 구현했다. DVF_AUTHORITY_ROLE_MIGRATION[5c37531e8b17c4bdec87cfae0bcd595d]
...
* Lua bridge export와 build / test contract를 current route 기준으로 재정렬했다.
  ...
  * Lua bridge exporter의 default route는 monolith가 아니라 chunk manifest + chunk files를 생성한다. DVF_AUTHORITY_ROLE_MIGRATION[b06ec50536c3b84b014997b0af257dc1]
