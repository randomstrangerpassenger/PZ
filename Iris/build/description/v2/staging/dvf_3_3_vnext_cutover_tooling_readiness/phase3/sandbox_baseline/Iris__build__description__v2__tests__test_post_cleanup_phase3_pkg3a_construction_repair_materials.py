...
class PostCleanupPhase3Pkg3AConstructionRepairMaterialsTest(unittest.TestCase):
    def test_build_pkg3a_promotes_only_safe_material_rows(self) -> None:
        ...
        try:
            ...
            base_facts_path = tmp / "dvf_3_3_facts.adopted DVF_AUTHORITY_ROLE_MIGRATION[bc90772a80695c2de29f423d5caa14db].jsonl"
            base_decisions_path = tmp / "dvf_3_3_decisions.adopted DVF_AUTHORITY_ROLE_MIGRATION[75dd6c39324cec11d473f930226c614c].jsonl"
            output_dir = tmp / "out"
