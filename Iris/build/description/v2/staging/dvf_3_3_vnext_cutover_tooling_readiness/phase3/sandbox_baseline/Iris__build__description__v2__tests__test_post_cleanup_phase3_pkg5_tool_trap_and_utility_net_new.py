...
class PostCleanupPhase3Pkg5ToolTrapAndUtilityNetNewTest(unittest.TestCase):
    def test_build_pkg5_promotes_full_kettle_and_keeps_other_tool_cohorts_on_backlog(self) -> None:
        ...
        try:
            ...
            base_facts_path = tmp / "dvf_3_3_facts.adopted DVF_AUTHORITY_ROLE_MIGRATION[dd071bf24b05e93f3a1b091ae5a59103].jsonl"
            base_decisions_path = tmp / "dvf_3_3_decisions.adopted DVF_AUTHORITY_ROLE_MIGRATION[8d8be7d4c749faa7ba7cf2df2f0026c0].jsonl"
            output_dir = tmp / "out"
