...
class SourceCoverageHoldPolicyTest(unittest.TestCase):
    ...
    def test_rebuild_checkpoint_tracks_integrated_runtime_when_present(self) -> None:
        ...
        self.assertEqual(checkpoint["current_phase_d_rendered_entry_count"], 2105 DVF_AUTHORITY_ROLE_MIGRATION[17e9068ae556551cae8f8a37df32531a])
    ...
    def test_notes_capture_hold_and_rebuild_positions(self) -> None:
        ...
        self.assertIn("current rendered entry count: `2105 DVF_AUTHORITY_ROLE_MIGRATION[723ffb3786d7de30506cd844f277d2a5]`", rebuild_note)
