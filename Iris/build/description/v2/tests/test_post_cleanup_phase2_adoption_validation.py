    ...
    def test_build_phase2_validation_checks_adopt_subset(self) -> None:
        ...
        try:
            ...
            payload = build_post_cleanup_phase2_adoption_validation(
                adoption_scope_manifest_path=adoption_scope_manifest_path,
                adopted_facts_path=output_dir / "dvf_3_3_facts.adopted.jsonl",  # DVF_AUTHORITY_ROLE_MIGRATION[7fef130945f605a93e1d84c8d48f7fc2]
                adopted_decisions_path=output_dir / "dvf_3_3_decisions.adopted.jsonl",  # DVF_AUTHORITY_ROLE_MIGRATION[c7c2d397895dd7cc9c3e0af761c2e4f7]
                adopted_rendered_path=output_dir / "dvf_3_3_rendered.adopted.json",  # DVF_AUTHORITY_ROLE_MIGRATION[7c04a78cf259cdfaa5864ad89065e601]
                output_dir=output_dir,
            )
