...
class PostCleanupPhase3RuntimeIntegrationTest(unittest.TestCase):
    def test_build_phase3_runtime_integration_overlays_promoted_rows_and_aggregates_backlog(self) -> None:
        ...
        try:
            base_facts_path = tmp / "dvf_3_3_facts.adopted DVF_AUTHORITY_ROLE_MIGRATION[3db8a64aa44d99e66454b9c4d818c039].jsonl"
            base_decisions_path = tmp / "dvf_3_3_decisions.adopted DVF_AUTHORITY_ROLE_MIGRATION[ad7a8274ac2e909701b9fe13c5415b11].jsonl"
