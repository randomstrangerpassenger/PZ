    ...
    files.extend(
        [
            ...
            (
                root
                / "Iris/_docs/round3/"
                "dvf_3_3_food_semantic_facts_authority_reconstruction/"
            ...
            (
                ...
                / "Iris/build/description/v2/staging/"
                "dvf_3_3_food_semantic_facts_authority/attempts/"
                "attempt-0021/post_implementation_reviews/"
                "external_implementation_review.json"
            ),
            (
                tests
    ...
    *,
    ...
    implementation_predicates = {
        ...
        "threshold_authority_candidate_binding_exact_without_credit": (
            ...
            and threshold["detector_execution_count"] == 0
            and no_relaxation["candidate_patch_targets_detector_symbol"]
            is False
            and no_relaxation["candidate_patch_executes_detector"] is False
...
def prepare_terminal_closeout(
    ...
    *,
    ...
    canonical_deferment = load_json(canonical_deferment_path)
    sealed_receipt_path = (
    ...
    if (
        ...
        != 0
        or canonical_deferment.get("O-12_in_round_disposition")
