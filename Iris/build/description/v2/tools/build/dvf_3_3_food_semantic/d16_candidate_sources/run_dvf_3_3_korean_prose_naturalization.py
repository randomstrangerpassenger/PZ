...
EXPECTED_CANONICAL_DETECTOR_GIT_BLOB_ID = (
    "44996ed2e658e06418ebb9277d6cce5aad00af55"
)
...
def build_canonical_text_skeleton_deferment(
    *,
    threshold_policy_path,
    threshold_denominator_binding_path,
):
    """Bind the canonical detector without substituting a Phase 2 approximation."""
    ...
    historical_readpoint_threshold_value = (
        canonical_candidate_denominator * numerator // denominator
    )
    if historical_readpoint_threshold_value != preserved_threshold_value:
    ...
    threshold_binding = {
        ...
        "historical_readpoint_resolved_threshold_value": (
            historical_readpoint_threshold_value
        ),
        ...
        "detector_source_commit": EXPECTED_THRESHOLD_POLICY_SOURCE_COMMIT,
        "detector_source_git_blob_id": (
            EXPECTED_CANONICAL_DETECTOR_GIT_BLOB_ID
        ),
        "detector_symbol": "text_skeleton",
        "detector_required_input": "actual_candidate_text_ko",
        ...
        "compatibility_identity_binding_only": True,
    }
    deferment_report = {
        "schema_version": "food-semantic-canonical-text-skeleton-deferment-v1",
        "status": "PASS",
        ...
        "actual_candidate_text_ko_required": True,
        "canonical_same_skeleton_acceptance_claim_allowed": False,
        "facts_round_sealed_successor_handoff_complete_claim_allowed": True,
        "render_write_count": 0,
    }
    return {
        "threshold_authority_binding": threshold_binding,
        "canonical_text_skeleton_deferment_report": deferment_report,
    }
...
def consume_food_semantic_inputs_no_render(
    *,
    ...
    skeleton_deferment = build_canonical_text_skeleton_deferment(
