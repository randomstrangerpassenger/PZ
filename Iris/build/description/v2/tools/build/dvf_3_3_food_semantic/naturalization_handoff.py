...
CANONICAL_DETECTOR_SOURCE_GIT_BLOB_ID = (
...
CANDIDATE_SPECS = [
    {
        ...
        "affected_symbols": [
            ...
            "_member_set_sha256",
            "_sha256_file",
            "build_canonical_text_skeleton_deferment",
...
def run_phase12(root: Path, attempt_root: Path) -> dict[str, Any]:
    ...
    write_json(
        phase / "threshold_authority_binding.json",
        {
            ...
            "detector_source_commit": POLICY_SOURCE_COMMIT,
            ...
            "candidate_deferment_adapter_path": runner_candidate[
                "candidate_path"
            ],
            "candidate_deferment_adapter_sha256": runner_candidate[
                "replacement_sha256"
            ],
            "candidate_deferment_adapter_symbol": (
                "build_canonical_text_skeleton_deferment"
            ),
    ...
    write_json(
        phase / "no_relaxation_attestation.json",
        {
            ...
            "candidate_patch_executes_detector": False,
            "candidate_adapter_reads_bound_policy_identity": True,
            "candidate_adapter_ratio_matches_preserved_policy": True,
    ...
    write_json(
        phase / "canonical_text_skeleton_deferment_report.schema.json",
        {
            "requires_actual_phase2_consumer": True,
            "requires_selected_successor_binding": True,
            "requires_canonical_threshold_binding": True,
            "canonical_detector_execution_required_in_facts_round": False,
            "semantic_profile_substitution_allowed": False,
            "maximum_same_skeleton_group_claim_allowed": False,
            "downstream_owner": "registry-adopted fresh Naturalization attempt",
