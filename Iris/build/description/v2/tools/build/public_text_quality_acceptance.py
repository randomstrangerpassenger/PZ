...
FOUNDATION_SCHEMA_VERSION = "public_text_quality_foundation_contract_v1"
READINESS_SCHEMA_VERSION = "public_text_quality_development_readiness_v1"
        ...
        "runner": {
            ...
            "foundation_root_policy": {
                "repository_local_default": (
                    "exact_tracked_s1_foundation_root_only"
                ),
...
def build_foundation_contract(foundation_id: str) -> dict[str, Any]:
    ...
    return {
        ...
        "owner_instruction_scope": "implement_s1_foundation_only",
...
def validate_foundation_root(root: Path) -> Path:
    ...
    if resolved.is_relative_to(repository) and resolved != default:
        raise FoundationContractError(
            "repository-local foundation root must be the exact tracked S1 foundation root"
        )
    return resolved
