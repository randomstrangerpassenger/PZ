...
CURRENT_BASELINE = {
    "row_count": 2105,  # DVF_AUTHORITY_ROLE_MIGRATION[96f18502aee9d64196dbd23872a9af6b]
    "runtime_state_counts": {ADOPTED_RUNTIME_STATE: 2084, UNADOPTED_RUNTIME_STATE: 21},  # DVF_AUTHORITY_ROLE_MIGRATION[f613f10e573175b7b39fa4ca00cd1d05] DVF_AUTHORITY_ROLE_MIGRATION[cc544d465ae83b3be43b64e30cc02839]
    "runtime_path_counts": {
...
def build_regression_gate_report(
    *,
    ...
    payload = {
        ...
        "baseline_enforcement": "current_2105_quality_baseline_v4" if enforce_current_baseline else "disabled_for_test_or_diagnostic",  # DVF_AUTHORITY_ROLE_MIGRATION[ce54da4fd80c52d45e65605db4680ef8]
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Disable sealed 2105 runtime/quality/publish baseline checks for isolated diagnostics only.",  # DVF_AUTHORITY_ROLE_MIGRATION[dc1d11455c9464cb70a886dd401857c7]
    )
