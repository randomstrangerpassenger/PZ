...
def validate_food_semantic_consumed_input_receipt(
    ...
    *,
    ...
    if receipt.get("canonical_text_skeleton_evaluation_state") != (
        "deferred_to_registry_adopted_fresh_naturalization_attempt"
    ):
        mismatches.append("canonical_text_skeleton_evaluation_state")
    for zero_field in (
    ...
    for forbidden_field in (
        ...
        if forbidden_field in receipt:
            mismatches.append(f"forbidden:{forbidden_field}")
