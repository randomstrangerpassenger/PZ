...
CONTEXT = require_repository_context()
IRIS_DIR = CONTEXT.iris_root
raw_output_root = os.environ.get("IRIS_CLEAN_CHECKOUT_LEGACY_OUTPUT_ROOT")
OUTPUT_DIR = (
    Path(raw_output_root).resolve()
    if raw_output_root
    else IRIS_DIR / "output"
)
