...
def _remove_matrix_checkout(path: Path) -> None:
    from Iris.validation.baseline.collect_baseline_qualification import _remove_checkout
...
def qualification_over_budget_preflight_case(source_repo: Path, root: Path) -> dict[str, Any]:
    ...
    from Iris.validation.baseline.collect_baseline_qualification import qualify
    ...
    contract = read_json(candidate_repo / "Iris/validation/baseline/contracts/windows_path_contract.json")
