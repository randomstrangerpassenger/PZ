"""Bind declared fault-to-test mappings to their protection map and source hashes."""
...
from source_metrics_io import ContractError, read_jsonl, sha256_file, write_json
