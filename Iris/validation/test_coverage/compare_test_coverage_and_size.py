"""Compare declared test protections and source-size metrics before and after edits."""
...
from source_metrics_io import ContractError, read_json, read_jsonl, write_json
