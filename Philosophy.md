...
또한 나중에 추가될 리스소팩 기능들을 Cortex가 가이드 역할을 해 줄 예정
...
창작마당에 있는 Nerve는 핵심기능만, Pulse 의존성을 가진 Nerve+는 핵심기능 + 편의기능을 포함함. Fuse는 처음부터 기반이 없었기에 Pulse 의존성으로 바꾸기 수월함. 갑작스럽다고 느끼지않게 미리 "정식 공개시 업데이트로 안정성을 위해 플랫폼 의존성을 가진 버전으로 변환 가능"이라고 명시해두기.
