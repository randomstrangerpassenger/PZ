...
- Exact implementation `2e13049d`의 terminal W10은 clean tracked 1,751 files / 71,733,963 Git blob bytes, clean physical 1,751 files / 72,311,106 bytes, custody Iris physical 1,751 files / 72,121,258 bytes를 기록한다. Custody Iris ignored/untracked/filesystem-only/reparse는 모두 0이다.
- Terminal capsule은 133,094 bytes이고 successor overhead는 1,590,263 bytes로 각각 2,359,296-byte 및 3,037,162-byte ceiling 이내다.
