...
>
> 코드 조사 기준점: branch `main`, HEAD `129c6c124ffa5a6b671041c6ab86675c660fb494`
>
...
>
> 주의: 위 hash, row count, profile count, quality count는 계획 작성 시점의 관찰값이다. 실행 권한이나 봉인된 baseline을 뜻하지 않으며 Phase 0에서 live checkout을 다시 측정한다.
