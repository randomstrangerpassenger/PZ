...
| OPT-005 same-name predecessor copies | 33 concrete pairs: 5 exact, 28 diverged | `retire_predecessor_copy` | 33 archived and physically retired; different-name exact duplicate count remained 0 |
...
- default current-context tracked bytes: `170476 → 149600`
