...
public class AccessWidener {
    ...
    private Class<?> loadClass(String className) {
        return classCache.computeIfAbsent(className, name -> {
            try {
                ...
                System.err.println("[Mutagen/Access] Class not found: " + name);
                return null;
            }
        });
    }
    ...
    private Object getFieldValue(Class<?> clazz, Object instance, String fieldName) {
        ...
        try {
            ...
            System.err.println("[Mutagen/Access] Cannot access field: " + fieldName);
            return null;
        }
    }
    ...
    private void setFieldValue(Class<?> clazz, Object instance, String fieldName, Object value) {
        ...
        try {
            ...
            System.err.println("[Mutagen/Access] Cannot set field: " + fieldName);
        }
    }
    ...
    private Field findField(Class<?> clazz, String fieldName) {
        ...
        return fieldCache.computeIfAbsent(key, k -> {
            ...
            System.err.println("[Mutagen/Access] Field not found: " + fieldName);
            return null;
        });
    }
    ...
    private Object invokeMethod(Class<?> clazz, Object instance, String methodName, Object... args) {
        ...
        try {
            ...
            System.err.println("[Mutagen/Access] Cannot invoke method: " + methodName);
            e.printStackTrace();
            return null;
        }
    }
    ...
    private Method findMethod(Class<?> clazz, String methodName, Object... args) {
        ...
        return methodCache.computeIfAbsent(key, k -> {
            ...
            System.err.println("[Mutagen/Access] Method not found: " + methodName);
            return null;
        });
    }
    ...
    private Object createInstance(Class<?> clazz, Object... args) {
        try {
            ...
            System.err.println("[Mutagen/Access] No matching constructor found");
            return null;
        } catch (Exception e) {
            System.err.println("[Mutagen/Access] Cannot create instance of: " + clazz.getName());
            e.printStackTrace();
            return null;
        }
    }
