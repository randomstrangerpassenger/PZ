...
public class ConfigManager {
    ...
    public void registerConfig(Class<?> configClass) {
        ...
        System.out.println("[Mutagen/Config] Registered config: " + spec.getModId());
    ...
    public void loadConfig(Class<?> configClass) {
        ...
        if (spec == null) {
            System.err.println("[Mutagen/Config] Config not registered: " + configClass.getName());
            return;
        }
        ...
        try {
            ...
            System.out.println("[Mutagen/Config] Loaded: " + configFile.getFileName());

        } catch (Exception e) {
            System.err.println("[Mutagen/Config] Failed to load " + configFile + ": " + e.getMessage());
            // 로드 실패 시 기본값 유지
        }
    }
    ...
    public void saveConfig(Class<?> configClass) {
        ...
        try {
            ...
            System.out.println("[Mutagen/Config] Saved: " + configFile.getFileName());

        } catch (Exception e) {
            System.err.println("[Mutagen/Config] Failed to save " + configFile + ": " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    private Object parseValue(JsonElement element, Class<?> type) {
        ...
        try {
            ...
            System.err.println("[Mutagen/Config] Failed to parse value: " + e.getMessage());
            return null;
        }
    }
