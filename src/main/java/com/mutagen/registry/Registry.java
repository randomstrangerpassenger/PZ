...
public class Registry<T> {
    ...
    public static <T> Registry<T> create(Identifier registryId) {
        ...
        System.out.println("[Mutagen/Registry] Created registry: " + registryId);
        return registry;
    }
    ...
    public T register(Identifier id, T value) {
        ...
        System.out.println("[Mutagen/Registry] Registered " + registryId + " -> " + id);
        return value;
    }
    ...
    public void freeze() {
        ...
        frozen = true;
        System.out.println("[Mutagen/Registry] Frozen " + registryId + " with " + entries.size() + " entries");
    }
