...
/**
 * Mutagen용 Mixin 로거 구현.
 */
public class MutagenLogger implements ILogger {
    private final String name;

    public MutagenLogger(String name) {
        this.name = name;
    }
    ...
    private String format(String level, String message, Object... params) {
        ...
        return String.format("[Mutagen/%s] [%s] %s", level, name, formatted);
    }
