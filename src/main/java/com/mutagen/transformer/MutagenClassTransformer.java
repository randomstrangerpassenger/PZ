package com.mutagen.transformer;
 ...
 */
public class MutagenClassTransformer implements ClassFileTransformer {
    ...
    public void connectMixinTransformer(IMixinTransformer transformer) {
        ...
        if (mixinReady) {
            System.out.println("[Mutagen/Transformer] Mixin transformer connected successfully");
        } else {
            System.err.println("[Mutagen/Transformer] WARNING: Mixin transformer is null!");
        }
    }
    ...
    private byte[] applyMixinTransform(String className, byte[] classfileBuffer) {
        ...
        try {
            ...
            if (result != null && result != classfileBuffer) {
                ...
                System.out.println("[Mutagen/Transformer] ✓ Mixin applied to: " + dotName);
                return result;
            }

        } catch (Throwable t) {
            System.err.println("[Mutagen/Transformer] Error transforming: " + dotName);
            t.printStackTrace();
        }
